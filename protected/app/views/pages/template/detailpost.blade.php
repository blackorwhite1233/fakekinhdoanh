...
<div id="body_wrapper">
  <div class="container">
        ...
        <div id="main">
          <div class="block">
              <div class="block_heading"><h2>Cập nhật sản phẩm</h2></div>
                <div class="block_content">
                  <div class="product_form">
                        ...
                        <form method="post" action="{{URL::to('')}}/home/suatin" enctype="multipart/form-data">
                            <input type="hidden" name="post_id" value="{{$input['post_id']}}" />
                            ...
                            <div class="input-group">
                              ...
                              @if($input['post_image'] != "")
                                    <img src="{{URL::to('')}}/uploads/post/thumb/{{$input['post_image']}}"/>
                              @else
